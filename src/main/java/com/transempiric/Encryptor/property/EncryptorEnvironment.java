...
/**
 */
public class EncryptorEnvironment extends StandardEnvironment implements ConfigurableEnvironment {
    ...
    public EncryptorEnvironment(EncryptorInterceptionMode interceptionMode, EncryptorPropertyResolver resolver) {
    ...
    public static <T> PropertySource<T> makeEncryptable(EncryptorInterceptionMode interceptionMode, EncryptorPropertyResolver propertyResolver, PropertySource<T> propertySource) {
        ...
        //log.info("Converting PropertySource {} [{}] to {}", propertySource.getName(), propertySource.getClass().getName(), AopUtils.isAopProxy(encryptablePropertySource) ? "AOP Proxy" : encryptablePropertySource.getClass().getName());
